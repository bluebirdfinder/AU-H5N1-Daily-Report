...
## 📅 2026-07-30 15:45：DAFF / PIRSA 7/30 下午最新通報 — 南澳林肯港 (Port Lincoln) 新增巨鸌確診，全澳精確累計 28 例確診 (SA 15 例)

- **7/30 下午最新疫情數據**：
  - **南澳 Port Lincoln 新增巨鸌確診 (CASE-032)**：南澳艾爾半島 (Eyre Peninsula) 林肯港 (Port Lincoln) 新增 1 隻野生巨鸌確診，使南澳累計確診推升至 **15 例**。
  - **全澳確診精確分佈 (總計 28 例)**：
    - 南澳洲 (SA): **15 例**
    - 西澳洲 (WA): **10 例**
    - 新南威爾斯州 (NSW): **2 例**
    - 昆士蘭州 (QLD): **1 例**
    - 維多利亞州 (VIC): **1 例** (7/30 波特蘭 Portland 首例，5 個 mainland 州全數淪陷)
  - **南澳 PIRSA 追加通報 13 隻新疑似**：南澳今日再通報 13 隻大鳳頭燕鷗集體生病/死亡疑似個案，使南澳待覆核個案總數達 24 例，已全數送往 CSIRO ACDP 國家實驗室檢驗。
  - **商業家禽安全保證**：聯邦 DAFF 強調，不論是澳洲還是紐西蘭，所有商業家禽農場目前依然 **100% 零感染**，未受波及。生產鏈與本廠安全無虞。
